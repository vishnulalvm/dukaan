...
import 'package:dukaan/screens/premium_screen.dart';
        ...
        child: ListView(
          children: [
            const ListTile(
              ...
              title: Text('Homely',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const Column(
                    children: [Text('Available credits'), Text('10.0')],
                  ),
                  ElevatedButton(
            ...
            ListTile(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (ctx) => const AdditionalInfoScreen()));
              },
